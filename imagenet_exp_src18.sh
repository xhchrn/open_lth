...
for mapping in $mapping1; do
    python open_lth.py lottery_branch change_depth --num_workers 16 --default_hparams=imagenet_resnet_50 --model_name imagenet_resnet_18 --rewinding_steps 5ep --replicate=$replicate \
